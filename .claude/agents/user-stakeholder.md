...
- **You author:** `UE_*` (User Expectations).
- **You co-author / review** (clinical & real-world-use lens): `KA_*`, `IU_01`/`MD_01`, `UR_*`, `USER_DFMEA_*`, `UT_*`, `UFMEA_*`, `UC_*`. Improve and challenge the draft you are given; do not rewrite it wholesale, and keep its IDs, structure, and traces intact.
